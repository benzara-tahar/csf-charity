...
const DEFAULT_VARS: { [key: string]: NzSafeAny } = {
  'primary-color': { label: 'primary color', type: 'color', default: '#1890ff' },
  ...
  'alain-default-header-padding': {
    label: 'Top left and right inner margin',
    type: 'px',
    default: '16px',
  },
  // Sidebar
  ...
  'alain-default-aside-nav-padding-top-bottom': {
    label: 'Item top and bottom inner margin',
    type: 'px',
    default: '8px',
    step: 8,
  },
  ...
  'alain-default-content-heading-border': {
    label: 'The border color at the bottom of the title',
    type: 'color',
    default: '#efe3e5',
  },
  ...
  'preserve-white-spaces-enabled': {
    label: 'Enable preserveWhitespaces',
    type: 'switch',
    default: true,
  },
  'nz-table-img-radius': {
